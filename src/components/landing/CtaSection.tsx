      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          <Link href="/anatomy" className="w-full">
            <Button 
              variant="outline" 
              className="w-full text-lg py-4 bg-gray-800/50 hover:bg-gray-800 border-gray-700 text-white"
            >
              Explore Anatomy
            </Button>
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <AnimatedSection animation="fadeIn" delay={200} className="text-center">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700">
              ...
              <p className="text-gray-400">Explore the heart from every angle with our detailed 3D model</p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection animation="fadeIn" delay={400} className="text-center">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700">
              ...
              <p className="text-gray-400">Calculate heart rate zones, BMI, and more with our interactive tools</p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection animation="fadeIn" delay={600} className="text-center">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-gray-700">
              ...
              <p className="text-gray-400">Test your understanding with our interactive quiz and get instant feedback</p>
            </div>
          </AnimatedSection>
        </div>
      </div>
