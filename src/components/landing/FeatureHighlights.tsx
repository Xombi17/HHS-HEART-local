...
const FeatureHighlights = () => {
  return (
    <section id="features-section" className="py-20 bg-white dark:bg-gray-900 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {features.map((feature, index) => (
            <AnimatedSection 
              ...
              animation="fadeIn" 
              delay={index * 200}
              className={`${feature.color} p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-800`}
            >
              ...
              <div className="flex justify-center">
                <Link href={feature.link}>
                  <Button variant="outline" size="md" className="w-full justify-center border-2 hover:shadow-md transition-all duration-300">
                    Learn More
