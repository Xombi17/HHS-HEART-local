    ...
    <section className="py-16 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <AnimatedSection animation="fadeIn" delay={200} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 border-l-4 border-yellow-500">
            ...
            <AnimatedSection animation="slideUp" delay={300} className="mb-4">
            ...
            <AnimatedSection animation="slideUp" delay={400} className="mb-4">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
